        ...
        <div class="container mt-4">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div>
                    ...
                    <a class="btn btn-outline-danger" href="ControladorCompra?accion=listar">Compra</a>
                      <a class="btn btn-outline-danger" href="ControladorInventario?accion=listar">Inventario</a>
                </div>
                <% } } %>
